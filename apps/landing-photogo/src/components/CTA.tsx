    ...
    <section id="early-access" className="border-t border-ink-900/5 py-20 dark:border-paper-100/5 sm:py-32">
      <div className="container-narrow">
        <div className="relative overflow-hidden rounded-3xl bg-ink-900 px-8 py-16 shadow-2xl dark:bg-ink-800 sm:px-12 sm:py-20">
          ...
          <div
            aria-hidden
            className="absolute -top-32 -right-32 -z-0 h-96 w-96 rounded-full bg-sunset-500/20 blur-3xl"
          />
          ...
          <div className="relative mx-auto max-w-2xl text-center">
            ...
            <form className="mx-auto mt-10 flex max-w-md flex-col gap-3 sm:flex-row">
              <input
                ...
                className="w-full rounded-full border border-paper-100/10 bg-ink-700 px-5 py-3 text-sm text-paper-50 placeholder:text-paper-300 focus:border-sunset-500 focus:outline-none focus:ring-2 focus:ring-sunset-500/40"
              />
